...
func newTbUser(db *gorm.DB, opts ...gen.DOOption) tbUser {
	...
	_tbUser.tbUserDo.UseModel(&dockermodel.TbUser{})
...
type ITbUserDo interface {
	...
	Unscoped() ITbUserDo
	Create(values ...*dockermodel.TbUser) error
	CreateInBatches(values []*dockermodel.TbUser, batchSize int) error
	Save(values ...*dockermodel.TbUser) error
	First() (*dockermodel.TbUser, error)
	Take() (*dockermodel.TbUser, error)
	Last() (*dockermodel.TbUser, error)
	Find() ([]*dockermodel.TbUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dockermodel.TbUser, err error)
	FindInBatches(result *[]*dockermodel.TbUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dockermodel.TbUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dockermodel.TbUser, error)
	FirstOrCreate() (*dockermodel.TbUser, error)
	FindByPage(offset int, limit int) (result []*dockermodel.TbUser, count int64, err error)
...
func (t tbUserDo) Create(values ...*dockermodel.TbUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbUserDo) CreateInBatches(values []*dockermodel.TbUser, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tbUserDo) Save(values ...*dockermodel.TbUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbUserDo) First() (*dockermodel.TbUser, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*dockermodel.TbUser), nil
	}
}

func (t tbUserDo) Take() (*dockermodel.TbUser, error) {
...
func (t tbUserDo) Last() (*dockermodel.TbUser, error) {
...
func (t tbUserDo) Find() ([]*dockermodel.TbUser, error) {
	result, err := t.DO.Find()
	return result.([]*dockermodel.TbUser), err
}

func (t tbUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dockermodel.TbUser, err error) {
	buf := make([]*dockermodel.TbUser, 0, batchSize)
...
func (t tbUserDo) FindInBatches(result *[]*dockermodel.TbUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tbUserDo) FirstOrInit() (*dockermodel.TbUser, error) {
...
func (t tbUserDo) FirstOrCreate() (*dockermodel.TbUser, error) {
...
func (t tbUserDo) FindByPage(offset int, limit int) (result []*dockermodel.TbUser, count int64, err error) {
...
func (t tbUserDo) Delete(models ...*dockermodel.TbUser) (result gen.ResultInfo, err error) {
