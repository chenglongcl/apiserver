...
func newTbArticle(db *gorm.DB, opts ...gen.DOOption) tbArticle {
	...
	_tbArticle.tbArticleDo.UseModel(&dockermodel.TbArticle{})
...
type ITbArticleDo interface {
	...
	Create(values ...*dockermodel.TbArticle) error
	CreateInBatches(values []*dockermodel.TbArticle, batchSize int) error
	Save(values ...*dockermodel.TbArticle) error
	First() (*dockermodel.TbArticle, error)
	Take() (*dockermodel.TbArticle, error)
	Last() (*dockermodel.TbArticle, error)
	Find() ([]*dockermodel.TbArticle, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dockermodel.TbArticle, err error)
	FindInBatches(result *[]*dockermodel.TbArticle, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dockermodel.TbArticle) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dockermodel.TbArticle, error)
	FirstOrCreate() (*dockermodel.TbArticle, error)
	FindByPage(offset int, limit int) (result []*dockermodel.TbArticle, count int64, err error)
...
func (t tbArticleDo) Create(values ...*dockermodel.TbArticle) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbArticleDo) CreateInBatches(values []*dockermodel.TbArticle, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tbArticleDo) Save(values ...*dockermodel.TbArticle) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbArticleDo) First() (*dockermodel.TbArticle, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*dockermodel.TbArticle), nil
	}
}

func (t tbArticleDo) Take() (*dockermodel.TbArticle, error) {
...
func (t tbArticleDo) Last() (*dockermodel.TbArticle, error) {
...
func (t tbArticleDo) Find() ([]*dockermodel.TbArticle, error) {
	result, err := t.DO.Find()
	return result.([]*dockermodel.TbArticle), err
}

func (t tbArticleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dockermodel.TbArticle, err error) {
	buf := make([]*dockermodel.TbArticle, 0, batchSize)
...
func (t tbArticleDo) FindInBatches(result *[]*dockermodel.TbArticle, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tbArticleDo) FirstOrInit() (*dockermodel.TbArticle, error) {
...
func (t tbArticleDo) FirstOrCreate() (*dockermodel.TbArticle, error) {
...
func (t tbArticleDo) FindByPage(offset int, limit int) (result []*dockermodel.TbArticle, count int64, err error) {
...
func (t tbArticleDo) Delete(models ...*dockermodel.TbArticle) (result gen.ResultInfo, err error) {
