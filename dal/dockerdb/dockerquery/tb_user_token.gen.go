...
import (
	...
	"apiserver/dal/dockerdb/dockermodel"
)
...
func newTbUserToken(db *gorm.DB, opts ...gen.DOOption) tbUserToken {
	...
	_tbUserToken.tbUserTokenDo.UseModel(&dockermodel.TbUserToken{})
...
type ITbUserTokenDo interface {
	...
	Create(values ...*dockermodel.TbUserToken) error
	CreateInBatches(values []*dockermodel.TbUserToken, batchSize int) error
	Save(values ...*dockermodel.TbUserToken) error
	First() (*dockermodel.TbUserToken, error)
	Take() (*dockermodel.TbUserToken, error)
	Last() (*dockermodel.TbUserToken, error)
	Find() ([]*dockermodel.TbUserToken, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dockermodel.TbUserToken, err error)
	FindInBatches(result *[]*dockermodel.TbUserToken, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dockermodel.TbUserToken) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dockermodel.TbUserToken, error)
	FirstOrCreate() (*dockermodel.TbUserToken, error)
	FindByPage(offset int, limit int) (result []*dockermodel.TbUserToken, count int64, err error)
...
func (t tbUserTokenDo) Create(values ...*dockermodel.TbUserToken) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbUserTokenDo) CreateInBatches(values []*dockermodel.TbUserToken, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tbUserTokenDo) Save(values ...*dockermodel.TbUserToken) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbUserTokenDo) First() (*dockermodel.TbUserToken, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*dockermodel.TbUserToken), nil
	}
}

func (t tbUserTokenDo) Take() (*dockermodel.TbUserToken, error) {
...
func (t tbUserTokenDo) Last() (*dockermodel.TbUserToken, error) {
...
func (t tbUserTokenDo) Find() ([]*dockermodel.TbUserToken, error) {
	result, err := t.DO.Find()
	return result.([]*dockermodel.TbUserToken), err
}

func (t tbUserTokenDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dockermodel.TbUserToken, err error) {
	buf := make([]*dockermodel.TbUserToken, 0, batchSize)
...
func (t tbUserTokenDo) FindInBatches(result *[]*dockermodel.TbUserToken, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tbUserTokenDo) FirstOrInit() (*dockermodel.TbUserToken, error) {
...
func (t tbUserTokenDo) FirstOrCreate() (*dockermodel.TbUserToken, error) {
...
func (t tbUserTokenDo) FindByPage(offset int, limit int) (result []*dockermodel.TbUserToken, count int64, err error) {
...
func (t tbUserTokenDo) Delete(models ...*dockermodel.TbUserToken) (result gen.ResultInfo, err error) {
