...
func newTbUser(db *gorm.DB, opts ...gen.DOOption) tbUser {
	...
	_tbUser.tbUserDo.UseModel(&apiservermodel.TbUser{})

	tableName := _tbUser.tbUserDo.TableName()
	_tbUser.ALL = field.NewAsterisk(tableName)
	_tbUser.ID = field.NewUint64(tableName, "id")
	_tbUser.Username = field.NewString(tableName, "username")
	_tbUser.Password = field.NewString(tableName, "password")
	_tbUser.Mobile = field.NewString(tableName, "mobile")
	_tbUser.Status = field.NewBool(tableName, "status")
...
type ITbUserDo interface {
	...
	Unscoped() ITbUserDo
	Create(values ...*apiservermodel.TbUser) error
	CreateInBatches(values []*apiservermodel.TbUser, batchSize int) error
	Save(values ...*apiservermodel.TbUser) error
	First() (*apiservermodel.TbUser, error)
	Take() (*apiservermodel.TbUser, error)
	Last() (*apiservermodel.TbUser, error)
	Find() ([]*apiservermodel.TbUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*apiservermodel.TbUser, err error)
	FindInBatches(result *[]*apiservermodel.TbUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*apiservermodel.TbUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*apiservermodel.TbUser, error)
	FirstOrCreate() (*apiservermodel.TbUser, error)
	FindByPage(offset int, limit int) (result []*apiservermodel.TbUser, count int64, err error)
...
func (t tbUserDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ITbUserDo {
...
func (t tbUserDo) Create(values ...*apiservermodel.TbUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbUserDo) CreateInBatches(values []*apiservermodel.TbUser, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tbUserDo) Save(values ...*apiservermodel.TbUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tbUserDo) First() (*apiservermodel.TbUser, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*apiservermodel.TbUser), nil
	}
}

func (t tbUserDo) Take() (*apiservermodel.TbUser, error) {
...
func (t tbUserDo) Last() (*apiservermodel.TbUser, error) {
...
func (t tbUserDo) Find() ([]*apiservermodel.TbUser, error) {
	result, err := t.DO.Find()
	return result.([]*apiservermodel.TbUser), err
}

func (t tbUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*apiservermodel.TbUser, err error) {
	buf := make([]*apiservermodel.TbUser, 0, batchSize)
...
func (t tbUserDo) FindInBatches(result *[]*apiservermodel.TbUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tbUserDo) FirstOrInit() (*apiservermodel.TbUser, error) {
...
func (t tbUserDo) FirstOrCreate() (*apiservermodel.TbUser, error) {
...
func (t tbUserDo) FindByPage(offset int, limit int) (result []*apiservermodel.TbUser, count int64, err error) {
...
func (t tbUserDo) Delete(models ...*apiservermodel.TbUser) (result gen.ResultInfo, err error) {
